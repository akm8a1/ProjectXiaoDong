...
public class SoftwareService extends AccessibilityService {
    ...
    public static  String qqMusicPlay = "qqMusicPlay";  //播放音乐命令
    ...
    public static String cloudMusicPlay = "cloudMusicPlay"; /*网易云音乐播放命令*/
    public static String cloudMusicStop = "cloudMusicStop"; /*网易云音乐暂停播放命令*/
    //其他软件
